...
<div class="custDetail center">
    ...
    <div class="formRow">
        <a class="fontColorWhite customerDisplay" href="../Controller/Controller.php?action=AdminPricing&Season=FallWinter">Fall/Winter Prices</a>
    </div>
    <div class="formRow">
        <a class="fontColorWhite customerDisplay" href="../Controller/Controller.php?action=AdminPricing&Season=SpringSummer">Spring/Summer Prices</a>
    </div> 
